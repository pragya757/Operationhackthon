...
# ── Public API ────────────────────────────────────────────────────────────────
def analyze_spectrogram(audio_path: str, y: Optional[np.ndarray] = None, sr: Optional[int] = None) -> Dict[str, Any]:
    """
    ...
    # 1. Load audio for heuristics + image rendering if not pre-provided
