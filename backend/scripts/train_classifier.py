...
================================================================================
Trains a high-accuracy, local machine learning model to classify messages and
call transcripts as fraud/scam (1) or legitimate/safe (0).
================================================================================
"""
...
CSV_DATASET = os.path.join(ROOT_DIR, "SMS fraud Dataset.csv")
CALL_DATASET = os.path.join(ROOT_DIR, "fraud_call.file")
SCAM_VOICE_DATASET = os.path.join(ROOT_DIR, "English_Scam.txt")
NONSCAM_VOICE_DATASET = os.path.join(ROOT_DIR, "English_NonScam.txt")
BETTER30_DATASET = os.path.join(ROOT_DIR, "BETTER30.csv")
FRAUD_CALLS_DATA_DATASET = os.path.join(ROOT_DIR, "fraud_calls_data.csv")
OUTPUT_DIR = os.path.join(ROOT_DIR, "backend", "models")

def load_data():
    """Load and merge all datasets, mapping labels to 0 (Safe) and 1 (Scam)."""
